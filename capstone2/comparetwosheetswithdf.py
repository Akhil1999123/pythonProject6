...
class CompareXLSheet():
    ...
    def compare(self,sheet1,sheet2,sh1_name,sh2_name):
        ...
        #self.df3=self.df1.compare(self.df2,align_axis=1)#keep_shape=True,keep_equal=True)
        #self.df3.to_excel("diif.xlsx")
        #print(self.df3)
        #print(self.df1.shape)
        #print(self.df2.shape)
        print(self.df3.query("Exist!='both'"))

sheet1_path="Arrival_Dates.xlsx"
sheet2_path="Arrival_Dates_Final.xlsx"
sheet1_name="Sheet1"
sheet2_name="Sheet1"
obj=CompareXLSheet()
